...
unsigned long RamAddressMappingC(int arrayId) {
    ...
    d0 = final_hexC[arrayId + 0];
    d1 = final_hexC[arrayId + 1];
    d2 = final_hexC[arrayId + 2];
    d3 = final_hexC[arrayId + 3];
...
void computeChecksumC(long long r1) {
    ...
    int j;
    j = 0;
    sprintf(stringC, "%lX", r1);
    if (strlen(stringC) < 8) {
        //pad = 8-strlen(string);
        strcat(zeroC, stringC);
        bzero(stringC, 10);
        strcpy(stringC, zeroC);
    }
    strncpy(a0, stringC + j, 2);
    //a0[3] = '\0';
    j = j + 2;
    strncpy(a1, stringC + j, 2);
    //a1[3] = '\0';
    j = j + 2;
    strncpy(a2, stringC + j, 2);
   // a2[3] = '\0';
    j = j + 2;
    strncpy(a3, stringC + j, 2);
   // a3[3] = '\0';
    j = j + 2;



    strncat(checksumC, a3, 2);
    strncat(checksumC, a2, 2);
    strncat(checksumC, a1, 2);
    strncat(checksumC, a0, 2);


}
void SimulatorIOBoard16KB_C() {
    ...
    char *b;
    memset(final_hexC, 0, sizeof(final_hexC));
    ...
    for (i = 0; i < (RAM_SIZE); i++) {
        if (i % 25 == 0)
            printf("\n");
        printf(" Index [%d] = %d ", i, final_hexC[i]);
    }*/
    ...
    for (r13 = 0x7800; r13 > 0; r13 = r13 - 0x8) {
        ...
        memVal = RamAddressMappingC(arrayId);
        r14 = memVal;
        r0 = r0 ^ r14;
        r14 = mrs;
    ...
    for(i=0;i<c;i++){
        ...
        RamAddressMappingC(store_index[i]);
    }
    ...
    computeChecksumC(r8);
    computeChecksumC(r9);
    computeChecksumC(r10);
    computeChecksumC(r11);
    computeChecksumC(r12);
    printf("%s", KGRN);
    for (i = 0; checksumC[i] != '\0'; i++) {
        checksumC[i] = tolower(checksumC[i]);
    }
