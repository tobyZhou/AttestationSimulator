...
unsigned long RamAddressMappingA(int arrayId) {
    ...
    d0 = final_hexA[arrayId + 0];
    d1 = final_hexA[arrayId + 1];
    d2 = final_hexA[arrayId + 2];
    d3 = final_hexA[arrayId + 3];
...
void SimulatorIOBoard16KB_A() {
    ...
    char *b;
   // memset(final_hexA, 0, sizeof (final_hexA));
    ...
    for (i = 0; i < (RAM_SIZE); i++) {
        if (i % 25 == 0)
            printf("\n");
        printf(" Index [%d] = %d ", i, final_hexA[i]);
    }*/
    ...
    for (r13 = 0x5000; r13 > 0; r13 = r13 - 0x8) {
        ...
        memVal = RamAddressMappingA(arrayId);
        r14 = memVal;
        r0 = r0 ^ r14;
        r14 = mrs;
    ...
    for(i=0;i<c;i++){
        ...
        RamAddressMappingA(store_index[i]);
    } 
    /*
    ...
    computeChecksumA(r8);
    computeChecksumA(r9);
    computeChecksumA(r10);
    computeChecksumA(r11);
    computeChecksumA(r12);
    printf("%s", KGRN);
    for (i = 0; checksumA[i] != '\0'; i++) {
        checksumA[i] = tolower(checksumA[i]);
    }
...
void computeChecksumA(long long r1) {
    ...
    int j;
    j = 0;
    sprintf(stringA, "%lX", r1);
    if (strlen(stringA) < 8) {
        //pad = 8-strlen(string);
        strcat(zeroA, stringA);
        bzero(stringA, 10);
        strcpy(stringA, zeroA);
    }
    strncpy(a0, stringA + j, 2);
    //a0[3] = '\0';
    j = j + 2;
    strncpy(a1, stringA + j, 2);
    //a1[3] = '\0';
    j = j + 2;
    strncpy(a2, stringA + j, 2);
    //a2[3] = '\0';
    j = j + 2;
    strncpy(a3, stringA + j, 2);
    //a3[3] = '\0';
    j = j + 2;



    strncat(checksumA, a3, 2);
    strncat(checksumA, a2, 2);
    strncat(checksumA, a1, 2);
    strncat(checksumA, a0, 2);
