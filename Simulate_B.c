...
unsigned long RamAddressMappingB(int arrayId) {
    ...
    d0 = final_hexB[arrayId + 0];
    d1 = final_hexB[arrayId + 1];
    d2 = final_hexB[arrayId + 2];
    d3 = final_hexB[arrayId + 3];
...
void computeChecksumB(long long r1) {
    ...
    int j;
    j = 0;
    sprintf(stringB, "%lX", r1);
    if (strlen(stringB) < 8) {
        //pad = 8-strlen(string);
        strcat(zeroB, stringB);
        bzero(stringB, 10);
        strcpy(stringB, zeroB);
    }
    strncpy(a0, stringB + j, 2);
    //a0[3] = '\0';
    j = j + 2;
    strncpy(a1, stringB + j, 2);
    //a1[3] = '\0';
    j = j + 2;
    strncpy(a2, stringB + j, 2);
   // a2[3] = '\0';
    j = j + 2;
    strncpy(a3, stringB + j, 2);
   // a3[3] = '\0';
    j = j + 2;



    strncat(checksumB, a3, 2);
    strncat(checksumB, a2, 2);
    strncat(checksumB, a1, 2);
    strncat(checksumB, a0, 2);


}
void SimulatorIOBoard16KB_B() {
    ...
    fp = fopen("ram_log_io_b", "rt");
    i = 0;
    int store_index[30720];
    c = 0;
    long sum;
    char c0, c1, c2, c3;
    ...
    char *b;
    memset(final_hexB, 0, sizeof(final_hexB));
    ...
    for (i = 0; i < (RAM_SIZE); i++) {
        if (i % 25 == 0)
            printf("\n");
        printf(" Index [%d] = %d ", i, final_hex[i]);
    }*/
    ...
    mrs = 0x60000029;
    for (r13 = 0x5000; r13 > 0; r13 = r13 - 0x8) {
        ...
        memVal = RamAddressMappingB(arrayId);
        r14 = memVal;
        r0 = r0 ^ r14;
        r14 = mrs;
    ...
    for(i=0;i<c;i++){
        ...
        RamAddressMappingB(store_index[i]);
    }
    ...
    computeChecksumB(r8);
    computeChecksumB(r9);
    computeChecksumB(r10);
    computeChecksumB(r11);
    computeChecksumB(r12);
    printf("%s", KGRN);
    for (i = 0; checksumB[i] != '\0'; i++) {
        checksumB[i] = tolower(checksumB[i]);
    }
