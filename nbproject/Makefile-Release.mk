...
${OBJECTDIR}/Simulate_A.o: Simulate_A.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Simulate_A.o Simulate_A.c

${OBJECTDIR}/Simulate_B.o: Simulate_B.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Simulate_B.o Simulate_B.c

${OBJECTDIR}/Simulate_C.o: Simulate_C.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Simulate_C.o Simulate_C.c

${OBJECTDIR}/Simulate_D.o: Simulate_D.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Simulate_D.o Simulate_D.c

${OBJECTDIR}/Simulate_MainBoard.o: Simulate_MainBoard.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Simulate_MainBoard.o Simulate_MainBoard.c
...
${OBJECTDIR}/openssl_hmac/hmac.o: openssl_hmac/hmac.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/openssl_hmac/hmac.o openssl_hmac/hmac.c

${OBJECTDIR}/openssl_hmac/md5.o: openssl_hmac/md5.c
	${MKDIR} -p ${OBJECTDIR}/openssl_hmac
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/openssl_hmac/md5.o openssl_hmac/md5.c
